...
if defined out_file (
    ...
    REM Create realistic Vina output
    echo REMARK VINA RESULT:    -7.234      0.000      0.000 > "%out_file%"
    echo REMARK VINA RESULT:    -6.891      0.000      0.000 >> "%out_file%"
    echo REMARK VINA RESULT:    -6.445      0.000      0.000 >> "%out_file%"
...
echo [DUMMY VINA] Completed successfully
exit /b 0 