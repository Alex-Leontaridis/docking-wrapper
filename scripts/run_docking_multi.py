...
def find_binary(binary_name, env_var=None, config_path=None):
    """
    Unified binary detection using PathManager.
    This function is deprecated - use path_manager.get_binary_path() instead.
    """
    from utils.path_manager import get_path_manager
    path_manager = get_path_manager()
    return path_manager.get_binary_path(binary_name)
